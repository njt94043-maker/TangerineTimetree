...
| D-119 | Card border flash on beat (no full-screen glow) | 2026-03-09 | Visible cards (visual hero, text panel, nav buttons) get border-color flash on every beat. Full-screen edge glow was prototyped but reverted — card-only glow looks cleaner. |
