...
| D-119 | Full-screen beat glow + card border flash | 2026-03-09 | Fixed-position div with `box-shadow: inset 0 0 60px 15px` flashes on every beat, bleeding behind all visible cards. Individual card borders also flash. Card-only was tested but full-screen glow looks better. |
