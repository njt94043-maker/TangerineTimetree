...
| D-116 | Per-user player preferences in user_settings | 2026-03-09 | 4 boolean columns: player_click_enabled, player_flash_enabled, player_lyrics_enabled, player_chords_enabled. Each member configures their own Live Mode experience. |
