...
- [ ] **S37: Web player polish** — Visual testing on thegreentangerine.com. Wake lock API. Waveform visualiser (Canvas). Player prefs settings UI (7 toggles). Set complete screen. Beat glow polish (D-119). Between-songs waiting screen.
