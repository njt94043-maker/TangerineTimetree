...
const s = StyleSheet.create({
  ...
  invoiceClient: { fontFamily: FONTS.bodyBold, fontSize: 14, color: COLORS.text },
  ...
  monthName: { fontFamily: FONTS.bodyBold, fontSize: 14, color: COLORS.text },
  ...
  outlineBtnText: { fontFamily: FONTS.body, fontSize: 14, color: COLORS.textDim },
  ...
  emptyText: { fontFamily: FONTS.body, fontSize: 14, color: COLORS.textMuted, marginTop: 8, textAlign: 'center', marginBottom: 16 },
});
