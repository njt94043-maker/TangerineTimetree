...
public:
    ...
    /** Set the sample rate used by the tempo calculations (default: 44100 Hz)
     * @param sr the audio sample rate in Hz (e.g. 48000)
     * Call immediately after construction if using a non-44100 Hz sample rate.
     */
...
private:
    ...
    int sampleRate_;                        /**< sample rate of the audio being processed (default 44100) */
